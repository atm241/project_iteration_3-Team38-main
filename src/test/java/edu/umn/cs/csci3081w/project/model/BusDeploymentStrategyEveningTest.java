...
public class BusDeploymentStrategyEveningTest {
  ...
  public void testGetNextBus() {
    ...
    Bus testBus2 = busDeploymentStrategyEvening.getNextBus("1", testOutRoute, testInRoute, 1);
    Bus testBus3 = busDeploymentStrategyEvening.getNextBus("2", testOutRoute, testInRoute, 1);
    assertTrue(testBus instanceof SmallBus);
    assertTrue(testBus2 instanceof RegularBus);
    assertTrue(testBus3 instanceof LargeBus);
  }
}
